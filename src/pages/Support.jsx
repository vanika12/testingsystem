...
function Support() {
  ...
  const [selectedQuestion, setSelectedQuestion] = useState("") // ✅ new state

  const chatRef = useRef(null) // ✅ reference to chat section
  ...
  // ✅ handle click on quick question
  ...
  return (
    <div className="support-page">
      ...
      <div className="support-content">
        <div className="support-left">
          <div className="questions-section">
            ...
            <div className="quick-questions">
              {questions.map((q, idx) => (
                <div key={idx} className="quick-q" onClick={() => handleQuickQuestionClick(q)}>
                  {q}
                </div>
              ))}
            </div>
        ...
        <div className="support-right" ref={chatRef}>
          {/* ✅ Pass selectedQuestion to ChatPanel */}
...
//             <div className="quick-questions">
//               {questions.map((q, idx) => (
//                 <div key={idx} className="quick-q" onClick={() => window.scrollTo({ top: document.body.scrollHeight, behavior: "smooth" })}
// >
//                   {q}
//                 </div>
//               ))}
