...
function ChatPanel({ initialQuestion = "" }) {
  ...
  // ===== NEW EFFECT: robust scroll-to-bottom when initialQuestion changes =====
  // On mobile the component or its internal container may not be ready when the parent
  // triggers the change. Retry a few times with small delays until successful.
  useEffect(() => {
    ...
    const tryScroll = () => {
      ...
      if (attempts < maxAttempts) {
        timerId = setTimeout(tryScroll, intervalMs)
      } else {
