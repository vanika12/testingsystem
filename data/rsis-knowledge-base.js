...
// Hardcoded journals (keep here — not in JSON)
const journals = [
  {
    ...
    scope: "Publishes original research in sociology, psychology, economics, political science, education, and related fields.",
    keywords: ["sociology", "psychology", "economics", "education", "social", "policy", "society", "behavior", "culture", "humanities"],
  },
  {
    name: "International Journal of Research and Scientific Innovation",
    abbr: "IJRSI",
    focus: "Scientific research across all disciplines",
    scope: "Covers physics, chemistry, biology, mathematics, computer science, and interdisciplinary scientific research.",
    keywords: ["science", "scientific", "innovation", "biology", "chemistry", "physics", "mathematics", "data", "quantum", "nanotechnology", "artificial intelligence", "machine learning", "research"],
  },
  {
    name: "International Journal of Research and Innovation in Applied Science",
    abbr: "IJRIAS",
    focus: "Applied science and practical research",
    scope: "Focuses on engineering applications, technology transfer, industrial research, and practical innovations.",
    keywords: ["applied", "implementation", "practical", "experiment", "industrial", "agriculture", "chemical", "materials", "environmental", "sensor", "battery", "automation", "testing"],
  },
  {
    ...
    scope: "Covers cutting-edge technology, engineering innovations, software, management practices, and business applications.",
    keywords: ["engineering", "mechanical", "civil", "electrical", "technology", "management", "software", "robotics", "industrial", "automation", "hardware", "manufacturing", "ai", "iot", "blockchain", "supply chain"],
  },
];
